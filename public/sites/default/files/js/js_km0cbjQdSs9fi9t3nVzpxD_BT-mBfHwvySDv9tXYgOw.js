...
function dropDown() {
  ...
  if (buttonclicked == "1"){
    ...
    button = document.getElementsByClassName("myButton1");
  }
   if (buttonclicked == "2"){
    x = document.getElementById("vds");
    button = document.getElementsByClassName("myButton2");
  }
  if (buttonclicked == "3"){
    x = document.getElementById("tds");
    button = document.getElementsByClassName("myButton3");
  }
  if (buttonclicked == "4"){
    x = document.getElementById("seir");
    button = document.getElementsByClassName("myButton4");
  }
  if (buttonclicked == "5"){
    x = document.getElementById("textdata");
    button = document.getElementsByClassName("myButton5");
  }
  if (buttonclicked == "6"){
    x = document.getElementById("ml");
    button = document.getElementsByClassName("myButton6");
  }
